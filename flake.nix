        ...
        devShells.default = pkgs.devshell.mkShell {
          ...
          commands = [
            ...
            }
            {
              ...
              command = ''
                home-manager switch --flake '.#fancy' -b bck --impure
              '';
            }
            {
              name = "dev:update";
              ...
              help = "Update things";
              command = ''
                home-manager switch --flake '.#fancy' -b bck --impure --recreate-lock-file
              '';
            }
            {
            ...
            # --- NixOS ---
            {
              ...
              command = ''
                sudo nixos-rebuild switch --flake '.#fancy' --impure
              '';
            }
